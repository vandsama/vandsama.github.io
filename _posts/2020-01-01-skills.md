...
### Computer Programming and Data Visualization Software
...
### Automated Reporting Financial Software
...
French - Level C1 Business French Certificate Received December 2015 from Universite Catholique de l’Ouest


<html>
      <div class="squares">
            <div class="icon1">
               <p class="level">Intermediate Proficiency</p>
               <p class="languages">
                        Spanish <br>
                        Portuguese <br>
                        Japanese <br>
            ...
            <div class="icon2">
               <p class="level">Advanced Proficiency</p>
               <p class="languages">French</p>
           </div>
            <div class="icon3">
               <p class="level">Native Language</p>
